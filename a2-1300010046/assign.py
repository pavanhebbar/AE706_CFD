...
def ques6():
    ...
    plotfig('niter_w.png', 'No. of iterations v/s w', [niter], 'w', 'No. of iterations', ['SOR error'], w)
...
def ques7(wopt):
    ...
    plt.figure()
    plt.title('Convergence of Jacobi, Gauss-Siedel and SOR')
    plt.loglog(error_jac, label = 'Jacobi')
    plt.loglog(error_gs, label = 'Gauss Siedel')
    plt.loglog(error_sor, label = 'Gauss Siedel')
